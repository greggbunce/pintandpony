            ...
            <main className="container internal-main">
                ...
                <div className="row">
                    <div className="col-md-4">
                        <CardButton colour="teal" title="Pay bar" buttonLink="/contact" buttonText="Enquire now" icon={pintIcon}>
                            <h5>£99 deposit</h5>
                    ...
                    <div className="col-md-4">
                        <CardButton colour="green" title="Free bar" buttonLink="/contact" buttonText="Find out more" icon={wineIcon}>
                            <h5>From £35 PP</h5>
                    ...
                    <div className="col-md-4">
                        <CardButton colour="teal" title="Tab bar" buttonLink="/contact" buttonText="Enquire now" icon={champagneIcon}>
                            <h5>From £50</h5>
